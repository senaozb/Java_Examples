...
{ 
    ...
    public static void testClassTown()
    {
        ...
        {
            int len = 50;
            TownwithArrayList town = new TownwithArrayList(len);
            TownwithArrayList.House h1 = new TownwithArrayList.House(10, 2, 2, "black", 0, 'l', "Owner1");
            TownwithArrayList.Office o1 = new TownwithArrayList.Office(4, 10, "Dentist", 15, 'r', "Owner2");
            TownwithArrayList.Market m1 = new TownwithArrayList.Market(5, 4, 9, 20, 11, 'l', "Owner3");
            TownwithArrayList.Playground p1 = new TownwithArrayList.Playground(10, 40, 'r');
            town.EditMode(h1);
            town.EditMode(o1);
            town.EditMode(m1);
            town.EditMode(p1);
            ...
            TownwithArrayList.House h2 = new TownwithArrayList.House(10, 5, 2, "white", 45, 'l', "Owner4");
    ...
    {
        TownwithArrayList town = new TownwithArrayList(1); //default
        int flag = 0, check = 0;
        int decision;
        ...
        do
        {
            ...
            try 
            {
                ...
                town = new TownwithArrayList(decision);
                check = 1;
            }
            catch (Exception e) 
            {
    ...
    public static Element GetHouse()
    {
        ...
        while(flag == 0);
        obj = new TownwithArrayList.House(lengthObj, heightObj, roomNumber, color, index, direction, owner);
        return obj;
    }
    ...
    public static Element GetOffice()
    {
        ...
        while(flag == 0);
        obj = new TownwithArrayList.Office(lengthObj, heightObj, jobType, index, direction, owner);
        return obj;
    }
    ...
    public static Element GetMarket()
    {
        ...
        obj = new TownwithArrayList.Market(lengthObj, heightObj, openingTime, closingTime, index, direction, owner);
        return obj;
    }
    ...
    {
        TownwithArrayList.Playground obj;
        int flag = 0;
        int lengthObj = 0;
        int index = 0;
        char direction = 'r';
        ...
        obj = new TownwithArrayList.Playground(lengthObj, index, direction);
        return obj;
    }
}
