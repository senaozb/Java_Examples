...
{ 
    ...
    public static void testClassTown()
    {
        ...
        {
            int len = 50;
            TownwithLinkedList town = new TownwithLinkedList(len);
            TownwithLinkedList.House h1 = new TownwithLinkedList.House(10, 2, 2, "black", 0, 'l', "Owner1");
            TownwithLinkedList.Office o1 = new TownwithLinkedList.Office(4, 10, "Dentist", 15, 'r', "Owner2");
            TownwithLinkedList.Market m1 = new TownwithLinkedList.Market(5, 4, 9, 20, 11, 'l', "Owner3");
            TownwithLinkedList.Playground p1 = new TownwithLinkedList.Playground(10, 40, 'r');
            town.EditMode(h1);
            town.EditMode(o1);
            town.EditMode(m1);
            town.EditMode(p1);
            ...
            TownwithLinkedList.House h2 = new TownwithLinkedList.House(10, 5, 2, "white", 45, 'l', "Owner4");
    ...
    {
        TownwithLinkedList town = new TownwithLinkedList(1); //default
        int flag = 0, check = 0;
        int decision;
        ...
        do
        {
            ...
            try 
            {
                ...
                town = new TownwithLinkedList(decision);
                check = 1;
            }
            catch (Exception e) 
            {
    ...
    public static Element GetHouse()
    {
        ...
        while(flag == 0);
        obj = new TownwithLinkedList.House(lengthObj, heightObj, roomNumber, color, index, direction, owner);
        return obj;
    }
    ...
    public static Element GetOffice()
    {
        ...
        while(flag == 0);
        obj = new TownwithLinkedList.Office(lengthObj, heightObj, jobType, index, direction, owner);
        return obj;
    }
    ...
    public static Element GetMarket()
    {
        ...
        obj = new TownwithLinkedList.Market(lengthObj, heightObj, openingTime, closingTime, index, direction, owner);
        return obj;
    }
    ...
    {
        TownwithLinkedList.Playground obj;
        int flag = 0;
        int lengthObj = 0;
        int index = 0;
        char direction = 'r';
        ...
        obj = new TownwithLinkedList.Playground(lengthObj, index, direction);
        return obj;
    }
}
