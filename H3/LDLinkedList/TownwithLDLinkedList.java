...
public class TownwithLDLinkedList
{
    /**The length of the street */
    private int pathLength;
    /**Element type linked list to store the objects*/
    private LDLinkedList<Element> arrayElements;
   
    /**Constructor with a length parameter
    * @param pathLength the length of the street
    */
    public TownwithLDLinkedList(int pathLength) 
    {
        if(pathLength <= 0)
            ...
            arrayElements = new LDLinkedList<Element>();
    }
    ...
    */
    private void Add(House house)
    {
        ...
        {
            //Add the element to the Element linked list
