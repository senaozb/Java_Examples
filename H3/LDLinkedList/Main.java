...
{ 
    ...
    public static void testClassTown()
    {
        ...
        {
            int len = 50;
            TownwithLDLinkedList town = new TownwithLDLinkedList(len);
            TownwithLDLinkedList.House h1 = new TownwithLDLinkedList.House(10, 2, 2, "black", 0, 'l', "Owner1");
            TownwithLDLinkedList.Office o1 = new TownwithLDLinkedList.Office(4, 10, "Dentist", 15, 'r', "Owner2");
            TownwithLDLinkedList.Market m1 = new TownwithLDLinkedList.Market(5, 4, 9, 20, 11, 'l', "Owner3");
            TownwithLDLinkedList.Playground p1 = new TownwithLDLinkedList.Playground(10, 40, 'r');
            town.EditMode(h1);
            town.EditMode(o1);
            town.EditMode(m1);
            town.EditMode(p1);
            ...
            TownwithLDLinkedList.House h2 = new TownwithLDLinkedList.House(10, 5, 2, "white", 45, 'l', "Owner4");
    ...
    {
        TownwithLDLinkedList town = new TownwithLDLinkedList(1); //default
        int flag = 0, check = 0;
        int decision;
        ...
        do
        {
            ...
            try 
            {
                ...
                town = new TownwithLDLinkedList(decision);
                check = 1;
            }
            catch (Exception e) 
            {
    ...
    {
        TownwithLDLinkedList.House obj;
        int flag = 0;
        int lengthObj = 0;
        int heightObj = 0;
        int roomNumber = 0;
        ...
        while(flag == 0);
        obj = new TownwithLDLinkedList.House(lengthObj, heightObj, roomNumber, color, index, direction, owner);
        return obj;
    }
    ...
    {
        TownwithLDLinkedList.Office obj;
        int flag = 0;
        int lengthObj = 0;
        int heightObj = 0;
        ...
        while(flag == 0);
        obj = new TownwithLDLinkedList.Office(lengthObj, heightObj, jobType, index, direction, owner);
        return obj;
    }
    ...
    {
        TownwithLDLinkedList.Market obj;
        int flag = 0;
        int lengthObj = 0;
        int heightObj = 0;
        int openingTime = 9;
        ...
        obj = new TownwithLDLinkedList.Market(lengthObj, heightObj, openingTime, closingTime, index, direction, owner);
        return obj;
    }
    ...
    {
        TownwithLDLinkedList.Playground obj;
        int flag = 0;
        int lengthObj = 0;
        int index = 0;
        char direction = 'r';
        ...
        obj = new TownwithLDLinkedList.Playground(lengthObj, index, direction);
        return obj;
    }
}
